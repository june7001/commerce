        ...
        {option.values.map((value) => {
          ...
          return (
            <button
              ...
              className={clsx('flex min-w-[48px] items-center justify-center border px-3 py-2 ', {
                'cursor-default bg-black text-white ': isActive,
                'ring-1 ring-transparent transition duration-300 ease-in-out hover:scale-110  ':
